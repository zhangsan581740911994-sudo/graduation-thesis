...
export PORTFOLIO_MULTIMODAL_CONSERVATIVE_FRAC="${PORTFOLIO_MULTIMODAL_CONSERVATIVE_FRAC:-0.2}"
export PORTFOLIO_MULTIMODAL_CONSERVATIVE_STD="${PORTFOLIO_MULTIMODAL_CONSERVATIVE_STD:-0.08}"
export PORTFOLIO_MULTIMODAL_EXTREME_K_MAX="${PORTFOLIO_MULTIMODAL_EXTREME_K_MAX:-1}"
export PORTFOLIO_MULTIMODAL_EXTREME_STYLE="${PORTFOLIO_MULTIMODAL_EXTREME_STYLE:-rank_bimodal}"
...
echo "MM conservative_frac=$PORTFOLIO_MULTIMODAL_CONSERVATIVE_FRAC"
echo "MM conservative_std=$PORTFOLIO_MULTIMODAL_CONSERVATIVE_STD"
echo "MM extreme_k_max=$PORTFOLIO_MULTIMODAL_EXTREME_K_MAX"
echo "MM extreme_style=$PORTFOLIO_MULTIMODAL_EXTREME_STYLE"
echo "================================================================="
